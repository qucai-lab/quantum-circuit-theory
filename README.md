...
- **[00_postulates](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/00_postulates.ipynb)**
	- Dirac notation
...
- **[01_formalism](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/01_formalism.ipynb)**
	- Linear operators.
	...
	- Operator function.
- **[02_single_qubit_gates](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/02_single_qubit_gates.ipynb)**
	- Pauli gates.
...
- **[03_change_of_basis.ipynb](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/03_change_of_basis.ipynb)**
	- Measurement. 
	- From the $Z$-basis to the $X$-basis.
	- From the $Z$-basis to the $Y$-basis.
- **[04_two_qubit_gates](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/04_two_qubit_gates.ipynb)**
...
- **[05_multi_qubit_gates](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/05_multi_qubit_gates.ipynb)**
	- Multi-qubit gate $C_n^{j}(U_{2^m})$ with $n$ control qubits and $m$ target qubits.
- **[06_gate_circuit_identities](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/06_gate_circuit_identities.ipynb)**
...
- **[07_gate_decomposition](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/07_gate_decomposition.ipynb)**
	- Pauli decomposition. 
	- Single-qubit gate decomposition.
	- Two-qubit gate decomposition.
- **[08_universal_gate_set](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/08_universal_gate_set.ipynb)**
	- Obtaining the universal gate set.
- **[09_trotterization](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/09_trotterization.ipynb)**
...
- **[10_implementations](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/10_implementations.ipynb)**
...
- **[algebraic_identities](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/algebraic_identities.ipynb)**
	- Notation.
	- Representations.
	- Identities: algebraic proof of useful linear algebra identities for quantum circuits with SymPy and SciPy verification.
		...
		- Matrix exponential.
		- Rotations.
- **[glossary](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/glossary.ipynb)**
	- Jargon and Terminology.
- **[Q&A](https://github.com/qucai-lab/quantum-circuit-theory/blob/main/notebooks/Q_A.ipynb)**
